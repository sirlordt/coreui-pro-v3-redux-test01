  ...
  onClickButtonLogin = ( event ) => {
    ...
    if ( bFieldUsernameInvalid ||
      ...
      this.setState( {
        ...
        fieldUsernameMessage: bFieldUsernameInvalid ? "Username field is required" : "",
        fieldPasswordInvalid: bFieldPasswordInvalid,
        fieldPasswordMessage: bFieldPasswordInvalid ? "Password field is required" : ""
      } );
                ...
                <CCard className="p-4">
                  <CCardBody className="p-0">
                    <CForm>
                      ...
                      <CFormGroup className="mb-2">
                        <p className="text-muted text-center m-0">Or Login with</p>
                      </CFormGroup>
